...
This repo is a Phase 6 public scaffold for public-safe security and publication-boundary policy templates.

## Operating Rules

- Keep all content synthetic and public-safe.
- Use `Status: scaffolded`, `Publication state: public scaffold`, and `Release state: not released`.
